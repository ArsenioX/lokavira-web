...
@section('content')
    ...
    <div class="container-fluid page-header mb-5 wow fadeIn" data-wow-delay="0.1s">
        <div class="container">
            <h1 class="display-3 mb-4 animated slideInDown text-black">TikTok Management</h1>
        ...
        <div class="container">
            <div class="row g-5 align-items-center">
                <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.1s">
                    <p class="d-inline-block border rounded text-dark fw-semi-bold py-1 px-3 mb-3"><i
                            class="fab fa-tiktok me-2"></i>Spesialis TikTok</p>
                    <h1 class="display-5 mb-4">Kuasai FYP & Tingkatkan Konversi Penjualan</h1>
                    <p class="lead mb-4 text-muted">Dari ide konten yang menahan perhatian (hook), riset sound trending,
                        hingga optimasi katalog produk di Keranjang Kuning. Kami bantu brand Anda bersinar di platform
                        paling dinamis saat ini.</p>
                    <div class="d-flex gap-3 flex-wrap">
                        <a href="#harga-paket" class="btn btn-dark py-3 px-4 fw-bold rounded-pill text-white">Lihat Harga
                            Paket</a>
                ...
                <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.3s">
                    <img src="{{ asset('img/tiktokpkt.png') }}" class="img-fluid rounded shadow-lg w-100"
                        alt="TikTok Management Lokavira" style="object-fit: cover;">
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="container py-4">
            ...
            <div class="row g-4 text-center">
                <div class="col-lg-3 col-sm-6 wow fadeInUp" data-wow-delay="0.1s">
                    ...
                    <p class="text-muted small">Mencari sound viral dan merancang script video yang menarik sejak 3 detik
                        pertama.</p>
                </div>
                <div class="col-lg-3 col-sm-6 wow fadeInUp" data-wow-delay="0.2s">
                    <div class="step-icon"><i class="fa fa-video"></i></div>
                    <h5 class="fw-bold">2. Produksi Video</h5>
                    <p class="text-muted small">Proses editing dinamis dengan transisi, teks berjalan (caption), dan ritme
                        yang disukai audiens.</p>
                </div>
                <div class="col-lg-3 col-sm-6 wow fadeInUp" data-wow-delay="0.3s">
                    <div class="step-icon"><i class="fa fa-store"></i></div>
                    <h5 class="fw-bold">3. Optimasi Keranjang</h5>
                    <p class="text-muted small">Mendesain poster produk yang rapi agar etalase TikTok Shop Anda memancing
                        klik.</p>
                </div>
                <div class="col-lg-3 col-sm-6 wow fadeInUp" data-wow-delay="0.4s">
                    <div class="step-icon"><i class="fa fa-rocket"></i></div>
                    <h5 class="fw-bold">4. Posting di Jam FYP</h5>
                    <p class="text-muted small">Penjadwalan konten di jam-jam prime time beserta evaluasi views dan
                        interaksi.</p>
                </div>
            </div>
        </div>
        ...
        <div class="container">
            ...
            <div class="row g-4 justify-content-center align-items-center">
                ...
                <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                    <div class="card pricing-card h-100 border border-light shadow-sm p-4 p-xl-5 bg-white">
                        ...
                        <ul class="list-unstyled pricing-list text-muted small mb-4">
                            ...
                            <li><i class="fa fa-check text-dark me-3"></i><span>Riset Tren & Sound Viral Mingguan</span>
                            </li>
                            <li><i class="fa fa-check text-dark me-3"></i><span>Pembuatan Ide & Scripting Dasar</span></li>
                            <li><i class="fa fa-check text-dark me-3"></i><span>Merapikan Tampilan Profil & Bio
                                    TikTok</span></li>
                        ...
                        <div class="mt-auto pt-4">
                            <a href="https://wa.me/628138808690?text=Halo%20Loka,%20saya%20tertarik%20pesan%20Paket%20TikTok%20Essential"
                                class="btn btn-outline-dark w-100 py-3 rounded-pill fw-bold" target="_blank">Pilih Paket
                                Essential</a>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.2s">
                    <div class="card pricing-card h-100 border-0 shadow-lg p-4 p-xl-5 position-relative bg-dark"
                        style="transform: scale(1.05); z-index: 1;">
                        ...
                        <ul class="list-unstyled pricing-list text-white small mb-4">
                            <li><i class="fa fa-check text-warning me-3"></i><span>15 Video Konten (Fokus Hook
                                    Penjualan)</span></li>
                            <li><i class="fa fa-check text-warning me-3"></i><span>Riset Tren & Sound Viral Premium</span>
                            </li>
                            <li><i class="fa fa-check text-warning me-3"></i><span>Optimasi TikTok Shop (Desain Poster
                                    Etalase Keranjang Kuning)</span></li>
                            <li><i class="fa fa-check text-warning me-3"></i><span>Pembuatan Content Pillar &
                                    Scripting</span></li>
                            <li><i class="fa fa-check text-warning me-3"></i><span>Admin Posting di Jam Prime Time</span>
                            </li>
                        ...
                        <div class="mt-auto pt-4">
                            <a href="https://wa.me/628138808690?text=Halo%20Loka,%20saya%20tertarik%20pesan%20Paket%20TikTok%20FYP"
                                class="btn btn-warning text-dark fw-bold w-100 py-3 rounded-pill shadow"
                                target="_blank">Pilih Paket FYP</a>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.3s">
                    <div class="card pricing-card h-100 border border-light shadow-sm p-4 p-xl-5 bg-white">
                        ...
                        <ul class="list-unstyled pricing-list text-muted small mb-4">
                            ...
                            <li><i class="fa fa-check text-dark me-3"></i><span>Setup TikTok Ads Dasar (Saldo dari
                                    klien)</span></li>
                            ...
                            <li><i class="fa fa-check text-dark me-3"></i><span>Laporan Mingguan & Evaluasi Strategi</span>
                            </li>
                        </ul>
                        <div class="mt-auto pt-4">
                            <a href="https://wa.me/628138808690?text=Halo%20Loka,%20saya%20tertarik%20pesan%20Paket%20TikTok%20Scale-Up"
                                class="btn btn-outline-dark w-100 py-3 rounded-pill fw-bold" target="_blank">Pilih Paket
                                Scale-Up</a>
                        </div>
                    </div>
            ...
            <div class="row g-4 justify-content-center">
                <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                    <div class="portfolio-item shadow-sm text-center">
                        <img src="https://placehold.co/1280x720/212529/ffffff?text=Video+Edukasi" class="img-fluid w-100"
                            alt="Format Video Edukasi TikTok">
                        <p class="mt-3 fw-bold text-dark">Konten Edukasi / Storytelling</p>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.2s">
                    <div class="portfolio-item shadow-sm text-center">
                        <img src="https://placehold.co/1280x720/0C8C8C/ffffff?text=Video+Review" class="img-fluid w-100"
                            alt="Format Video Review TikTok">
                        <p class="mt-3 fw-bold text-dark">Konten Review & Showcase Produk</p>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.3s">
                    <div class="portfolio-item shadow-sm text-center">
                        <img src="https://placehold.co/1280x720/eab308/ffffff?text=Video+Trending" class="img-fluid w-100"
                            alt="Format Video Tren TikTok">
                        ...
                        <div class="accordion-item border-0 border-bottom">
                            ...
                            <div id="collapseOne" class="accordion-collapse collapse show" aria-labelledby="headingOne"
                                ...
                                <div class="accordion-body text-muted small">
                                    Tentu tidak! Algoritma TikTok sekarang sangat menyukai konten edukasi, voice over (suara
                                    latar belakang), hingga estetika produk. Kami akan menyesuaikan gaya video dengan wibawa
                                    dan identitas brand Anda.
                                </div>
                            </div>
                        </div>
                        <div class="accordion-item border-0 border-bottom">
                            ...
                            <div id="collapseTwo" class="accordion-collapse collapse" aria-labelledby="headingTwo"
                                data-bs-parent="#faqAccordion">
                                <div class="accordion-body text-muted small">
                                    Kami akan membantu mengelola tampilan toko online Anda. Tim kami fokus pada desain
                                    visual, mulai dari membuat cover poster produk hingga merapikan katalog di etalase
                                    Keranjang Kuning Anda agar terlihat profesional, jelas, dan memancing audiens untuk
    ...
    <div class="container-fluid py-5 text-center text-white wow fadeIn" data-wow-delay="0.1s"
        ...
        <div class="container">
            ...
            <p class="lead mb-4">Mari diskusi dengan tim ahli kami untuk menentukan strategi TikTok yang paling pas dengan
                produk Anda.</p>
            <a href="https://wa.me/628138808690?text=Halo%20Loka,%20saya%20mau%20konsultasi%20gratis%20untuk%20TikTok%20Marketing"
