...
@section('content')
    <style>
        ...
        /* SIHIR CSS PORTOFOLIO AGAR SERAGAM */
        .portfolio-item img {
            width: 100%;
            aspect-ratio: 16/9;
            /* Memaksa rasio kotak memanjang */
            object-fit: cover;
            /* Memotong kelebihan gambar tanpa bikin gepeng */
            border-radius: 15px;
    ...
    <div class="container-fluid page-header mb-5 wow fadeIn" data-wow-delay="0.1s">
        <div class="container">
            <h1 class="display-3 mb-4 animated slideInDown text-black">Instagram Management</h1>
            ...
            <div class="row g-5 align-items-center">
                <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.1s">
                    <p class="d-inline-block border rounded text-primary fw-semi-bold py-1 px-3 mb-3"><i
                            class="fab fa-instagram me-2"></i>Spesialis Instagram</p>
                    <h1 class="display-5 mb-4">Ubah Followers Menjadi Pelanggan Setia</h1>
                    <p class="lead mb-4 text-muted">Bukan sekadar feed yang cantik. Kami merancang strategi visual, Reels
                        yang relevan, dan copywriting persuasif untuk mendominasi algoritma Instagram dan meningkatkan
                ...
                <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.3s">
                    <img src="{{ asset('img/igpkt.png') }}" class="img-fluid rounded shadow-lg w-100"
                        alt="Instagram Management Lokavira" style="object-fit: cover;">
                </div>
            </div>
        </div>
    </div>
                ...
                <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                    <div class="card pricing-card h-100 border border-light shadow-sm p-4 p-xl-5 bg-white">
                        ...
                        <ul class="list-unstyled pricing-list text-muted small mb-4">
                            <li><i class="fa fa-check text-primary me-3"></i><span>14 Feed (termasuk 2 Carousel – efektif 10
                                    single + 2 multi)</span></li>
                        ...
                        <div class="mt-auto pt-4">
                            <a href="https://wa.me/628138808690?text=Halo%20Loka,%20saya%20mau%20pesan%20Paket%20Instagram%20Ignite"
                                class="btn btn-outline-primary w-100 py-3 rounded-pill fw-bold" target="_blank">Pilih Paket
                                Ignite</a>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.2s">
                    <div class="card pricing-card h-100 border-0 shadow-lg p-4 p-xl-5 position-relative bg-primary"
                        ...
                        <div class="position-absolute top-0 start-50 translate-middle">
                            <span class="badge bg-warning text-dark px-3 py-2 rounded-pill fw-bold border border-white">Most
                                Popular</span>
                        </div>
                        ...
                        <ul class="list-unstyled pricing-list text-white small mb-4">
                            <li><i class="fa fa-check text-warning me-3"></i><span>18 Feed + 5 Carousel (total 23 template
                                    konten)</span></li>
                            ...
                            <li><i class="fa fa-check text-warning me-3"></i><span>Laporan 3x (kinerja, minggu 1 tanpa
                                    laporan)</span></li>
                        </ul>
                        <div class="mt-auto pt-4">
                            <a href="https://wa.me/628138808690?text=Halo%20Loka,%20saya%20mau%20pesan%20Paket%20Instagram%20Boost"
                                class="btn btn-warning text-dark fw-bold w-100 py-3 rounded-pill shadow"
                                target="_blank">Pilih Paket Boost</a>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.3s">
                    <div class="card pricing-card h-100 border border-light shadow-sm p-4 p-xl-5 bg-white">
                        ...
                        <ul class="list-unstyled pricing-list text-muted small mb-4">
                            ...
                            <li><i class="fa fa-check text-primary me-3"></i><span>3x revisi konten pilar + 2x revisi per
                                    konten</span></li>
                            <li><i class="fa fa-check text-primary me-3"></i><span>Admin Posting & Scheduling</span></li>
                            ...
                            <li><i class="fa fa-check text-primary me-3"></i><span>Full Laporan 4x (edukasi + kinerja +
                                    solusi)</span></li>
                            <li><i class="fa fa-check text-primary me-3"></i><span>Support Ads 3%</span></li>
                        </ul>
                        <div class="mt-auto pt-4">
                            <a href="https://wa.me/628138808690?text=Halo%20Loka,%20saya%20mau%20pesan%20Paket%20Instagram%20Accelerate"
                                class="btn btn-outline-primary w-100 py-3 rounded-pill fw-bold" target="_blank">Pilih Paket
                                Accelerate</a>
                        </div>
                    </div>
                        ...
                        <div class="accordion-item border-0 border-bottom">
                            ...
                            <div id="collapseOne" class="accordion-collapse collapse show" aria-labelledby="headingOne"
                                ...
                                <div class="accordion-body text-muted small">
                                    Minimal kontrak kerja sama adalah 1 Bulan. Namun, kami sangat menyarankan klien untuk
                                    mengamankan slot perpanjangan di bulan berikutnya agar proses pengenalan algoritma dan
                                    pertumbuhan akun Anda tidak terputus di tengah jalan.
                                </div>
                            </div>
                        </div>
                        <div class="accordion-item border-0 border-bottom">
                            ...
                            <div id="collapseTwo" class="accordion-collapse collapse" aria-labelledby="headingTwo"
                                data-bs-parent="#faqAccordion">
                                <div class="accordion-body text-muted small">
                                    Sangat disarankan Anda menyediakan aset mentah (foto produk/video pabrik). Tim kami yang
                                    akan mengedit, menambahkan teks, sound, dan merangkainya menjadi konten siap posting.
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    <div class="container-fluid py-5 text-center text-white wow fadeIn" data-wow-delay="0.1s"
        ...
        <div class="container">
            ...
            <a href="https://wa.me/628138808690?text=Halo%20Loka,%20saya%20ingin%20diskusi%20custom%20paket%20Instagram"
