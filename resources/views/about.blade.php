...
{{-- SEO Meta Tags: Bagian ini yang membuat halaman About muncul unik di hasil pencarian Google --}}
@section('title', 'Tentang Kami - Lokavira Digital Marketing Agency')
@section('meta_description', 'Kenali Lokavira, partner strategis Anda dalam pertumbuhan bisnis digital melalui konten kreatif dan strategi media sosial yang terukur.')
        ...
        <div class="container">
            <div class="row g-4 align-items-end mb-4">
                <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.1s">
                    {{-- SEO Tip: Alt text membantu gambar muncul di Google Images --}}
                    <img class="img-fluid rounded shadow" src="{{ asset('img/about1.jpg') }}" alt="Tim Kreatif Lokavira Digital Marketing Agency">
                </div>
                    ...
                    <div class="border rounded p-4">
                        ...
                        <div class="tab-content" id="nav-tabContent">
                            ...
                            <div class="tab-pane fade" id="nav-mission" role="tabpanel" aria-labelledby="nav-mission-tab">
                                <p>Membantu klien mencapai target penjualan melalui strategi digital yang terukur dan efisien.</p>
                                <p class="mb-0">Memberikan layanan pengelolaan media sosial yang responsif, kreatif, dan inovatif.</p>
                            </div>
                    ...
                    <div class="col-lg-4 wow fadeIn" data-wow-delay="0.1s">
                        <div class="h-100">
                            <div class="d-flex">
                                ...
                                <div class="ps-3">
                                    <h4>Respon Cepat</h4>
                                    <span>Kami menghargai waktu Anda. Tim kami siap merespons kebutuhan dan revisi dengan kilat.</span>
                                </div>
                        ...
                        <div class="h-100">
                            <div class="d-flex">
                                ...
                                <div class="ps-3">
                                    ...
                                    <span>Dikerjakan oleh ahli strategi, konten kreator, dan desainer grafis berpengalaman.</span>
                                </div>
                                <div class="border-end d-none d-lg-block"></div>
                            </div>
                            <div class="border-bottom mt-4 d-block d-lg-none"></div>
                        ...
                        <div class="h-100">
                            <div class="d-flex">
                                ...
                                <div class="ps-3">
                                    ...
                                    <span>Kami hadir sebagai partner diskusi untuk merancang strategi digital marketing yang tepat sasaran bagi bisnis Anda.</span>
                                </div>
                            </div>
                        </div>
                    </div>
